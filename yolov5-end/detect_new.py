                        ...
                        if col_idx[j] >= 0:
                            ...
                            for k,Info in enumerate(INFO):
                                if Info[0] == 1:
                                    ...
                                    if Match_loc(Loc[col],Info[1]) & int(Cls[col]) == int(Info[4]):
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='datasets/test/WIN_20220420_11_46_51_Pro.mp4', help='file/dir/URL/glob, 0 for webcam')
    # 'datasets/test/WIN_20220403_16_29_35_Pro.mp4'
